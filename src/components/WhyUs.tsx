...
export const WhyUs: React.FC = () => {
  ...
  return (
    <section id="why-us" className="py-20 bg-[#FAFAFA] relative border-t border-slate-200 text-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-14 h-14 rounded-2xl bg-amber-50 border border-amber-200 flex items-center justify-center text-amber-800 group-hover:scale-110 transition-transform">
                      <Icon className="w-7 h-7 stroke-[2]" />
                    </div>
                    <span className="text-xs font-bold px-3 py-1 rounded-full bg-slate-50 border border-slate-200 text-amber-900">
                      {prop.badge}
                    </span>
                  </div>

                  <h3 className="font-display text-2xl font-bold text-slate-900 mb-3 group-hover:text-amber-800 transition-colors">
                    {prop.title}
                  </h3>
                ...
                <div className="pt-6 mt-6 border-t border-slate-100 flex items-center gap-2 text-xs font-bold text-amber-800">
          ...
          <div className="p-8 rounded-3xl bg-gradient-to-br from-[#FF4B3E] to-[#e0372b] text-white flex flex-col justify-between shadow-xl shadow-[#FF4B3E]/20">
            <div>
              <span className="text-xs font-black uppercase tracking-wider bg-black/20 px-3 py-1 rounded-full inline-block mb-4">
              ...
              <p className="text-white/95 text-sm sm:text-base font-normal leading-relaxed">
            ...
            <div className="pt-6 mt-6">
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 bg-[#0A192F] hover:bg-[#05101E] text-[#FFC800] font-black px-6 py-4 rounded-2xl text-xs uppercase tracking-wider transition-all shadow-md"
              >
